...
export default function SubordinatePicker({
  members,
  setMembers,
  supervisorID,
  className,
}: SubordinatePickerProps) {
  ...
  return (
    <div
      className={`${className ? className : ""} grid grid-cols-subordinatePicker`}
    >
      ...
      <div className="flex flex-col items-center gap-4 justify-center">
        <Button
          className="bg-background hover:bg-background-dark"
        ...
        <Button
          className="bg-background  hover:bg-background-dark"
          disabled={selected === null}
          onClick={handleRemoveSubordinate}
        >
